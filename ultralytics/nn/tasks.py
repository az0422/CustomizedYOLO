...
CUSTOM_DETECTOR = (DetectorTiny, DetectorTinyv2, DetectorTinyv3, DetectorTinyv4)
CUSTOM_DETECTOR_STR = ('detectortiny', 'detectortinyv2', 'detectortinyv3', 'detectortinyv4')
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
            ...
            args = [c2, *args]
                   ...
                   C2Tiny, C2Aug, C2TinyF, C2AugF, FireModule, FireC2):
            ...
            if m in (ResidualBlocks, PoolResidualBlocks, SEResidualBlocks, ResidualBlocks2,
                     ...
                     DWResidualBlocks3, CSPDWResidualBlocks3, C2Tiny, C2Aug, C2TinyF, C2AugF, FireC2):
                args.insert(2, n)
                n = 1
        else:
            c2 = ch[f]
